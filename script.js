...
let ads = document.getElementById("advers")
...
function getTotalPrice(){
    if (price.value != "") {
        ...
        total.style.backgroundColor = "rgb(220, 66, 186)"
    }else {
        total.style.backgroundColor = "rgb(66, 102, 220)";
        total.innerHTML = ""
    }
}
...
function showData() {
    ...
    for (let i = 0; i < prodList.length; i++) {
        table +=`           <tr>
                        ...
                        <td><button onclick="updateProd(${i})" type="button" value="Update">Update</button></td>
                        <td><button onclick="deleteProd(${i})" type="button" value="Delete">Delete</button></td>
                    </tr>`
